<%@ Page Title="资料管理" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Files.aspx.cs" Inherits="WebPages_Files" %>
    ...
    <div class="Content">
                    <div class="DataView" style="text-align: center;">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" EnableModelValidation="True"
                            Width="98%" Style="margin: 0 auto;" AllowPaging="True" PageSize="20" OnPageIndexChanging="GridView1_PageIndexChanging"
