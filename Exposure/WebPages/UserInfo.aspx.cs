...
public partial class WebPages_UserInfo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ViewState["sql"] = "Select * from UserInfo Where keshi='Exposure' Order by username";
            LoadData();
        }
    ...
    protected void Search_Click(object sender, EventArgs e)
    {
        ...
        chaxunstr = "%" + chaxunstr + "%";
        ViewState["sql"] = "Select * from UserInfo where (username like '" + chaxunstr + "'or num like '" + chaxunstr + "'or phone like '" + chaxunstr + "'or email like '" + chaxunstr + "') AND keshi='Exposure' order by username";
        LoadData();
    }
