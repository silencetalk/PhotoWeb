<%@ Page Language="C#" MasterPageFile="~/WebPages/MasterPage.master" AutoEventWireup="true" CodeFile="Changshang.aspx.cs" Inherits="WebPages_Changshang" Title="人员信息" %>
...
<div class="FormTitle">添加厂商人员信息</div>
<div class="FormInput">
<div class="FormBody">
<p>厂商：<asp:TextBox ID="TextBoxChangjia" runat="server" Width="100px" CssClass="TextboxStyle"></asp:TextBox></p>
...
<!--startprint-->
    ...
    <asp:Button ID="Changshang" runat="server" Text="厂商人员"  CssClass="MenuSelected"/>
    </div>
    <div class="SubView">
            ...
            BorderColor="#A0A0A0" BorderStyle="Solid"   BorderWidth="1px" DataKeyNames="ID">
                            <Columns>
                              <asp:TemplateField HeaderText="选择">
                                ...
                                <asp:BoundField DataField="changjia" HeaderText="厂家">
